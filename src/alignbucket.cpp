...
//Hypothesis about the numer of different lengths in the input
 ...
 * for that length. If a length is not present, its value for the number of
 ...
 * @param lastpos the lastarray  index to be used
 ...
 * @return a vector of pairs representing the buckets
 */
vector<pair<int, int> > print_intervals(vector<pair<int, int> > intervals)
{
    cout << "Intervals: " << endl;
